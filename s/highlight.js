(function() {
	...
	for (var i = 0; i < codes.length; i++) {
		var code = codes[i].innerHTML.split('\n');
		...
		while (code.length) {
			...
			if (code.length && !code[code.length-1].replace(/[\s\n\r]/g, '')) {
				code.pop();
				continue;
			}
			break;
...
"sh_url",-1],[/(?:TODO|FIXME|BUG)(?:[:]?)/g,"sh_todo",-1]],[[/"/g,"sh_string",-2],[/\\./g,"sh_specialchar",-1]],[[/'/g,"sh_string",-2],[/\\./g,"sh_specialchar",-1]]];highlight(void 0,void 0,"pre");